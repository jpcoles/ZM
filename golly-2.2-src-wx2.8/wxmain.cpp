...
void MainFrame::CreateToolbar()
{
   ...
   toolbarptr = new ToolBar(this, 0, ht-toolbarwd, wd, toolbarwd);
...
void MainFrame::ToggleFullScreen()
{
   ...
   if (fullscreen) {
      ...
      restorelayerbar = false; //showlayer;
//    if (restorelayerbar) {
//       ToggleLayerBar();
//    }

      ToggleLayerBar();
      if (!showlayer) ToggleLayerBar();
...
void MainFrame::OnMenu(wxCommandEvent& event)
{
   ...
   switch (id) {
      ...
      case ID_START:          if (inscript || generating) {
                              ...
                              break;
      case ID_STOP:           if (inscript || generating) { Stop(); } break;
