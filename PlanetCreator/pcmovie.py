...
class PCFrame(wx.Frame):
    ...
    def __init__(self, parent, id, title, size):
        ...
        Playbmp = wx.BitmapFromImage(wx.Image('Buttons/buttons_start_1.png',    wx.BITMAP_TYPE_PNG))
        PlayOverbmp = wx.BitmapFromImage(wx.Image('Buttons/buttons_start_2.png',    wx.BITMAP_TYPE_PNG))
